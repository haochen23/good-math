            ...
            <main className="flex-1 flex flex-col items-center justify-center px-4 py-8 md:py-12">
                ...
                >
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-xl font-medium transition-all ${selectedMode === 'standard'
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-xl font-medium transition-all ${selectedMode === 'unlimited'
